...
define('EMAILMGR_CURRENT_VERSION', "1.2.7");
...
function emailmanager_output_config($mudomain = null) {
	...
	if ($cpaneluser != "" && $cpanelpass != "" && $cpanelserver != "") {
		...
		if ($accountinfo->data->max != "") {
			...
			<label for="pwstrength" style="vertical-align: top; float: left; width: 50em;"><em>Set the password strength criteria for using the Password Match feature. If this password strength criteria is not met, a new cPanel password will be generated.</em></label>
			<p>&nbsp;</p>
