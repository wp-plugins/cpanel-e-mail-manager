...
Option 3 - Manual Upload: 1). Save the cPanel E-Mail Manager plugin zip file to your desktop. 2). Launch your FTP client and login to the WordPress directory. 3). Go to the plugins folder (/wp-content/plugins/) and upload the entire folder [emailmanager] located in the cPanel E-Mail Manager zip file.
